...
public class MyRenderer implements GLSurfaceView.Renderer
{
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config)
    {
        ...
        * имя объекта из блендера*/
        Apple = new TableObjects(c, new float[]{1f, 0f, 0f, 1.0f}, "ta2.obj");
        ...
        torch = new TableObjects(c, new float[]{0.6f, 0.6f, 0.6f, 1.0f}, "ta.obj");
    ...
    private void draw_picture()//отрисовываем объекты
    {
        ...
        torch.render(scene_positionAttribute, scene_normalAttribute, scene_colorAttribute);
    }
}
